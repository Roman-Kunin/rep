while True:
    ...
    print("\nДобрый вечер, дорогие друзья! Я — интерпретатор Python 3.7, и это шоу \"Кто хочет стать пенсионером!\" "
          "в нашей студии.")
    print(
        "\nУ вас имеется две подсказки: \"50x50\" и \"Право на ошибку\". Была ещё помощь зала, но какой нахрен зал? "
        "Даже в реальном шоу временно нет этой подсказки из-за ковида.")
    print("P.S. Использовать две подсказки на один вопрос также нельзя, так как их сочетание даст очевидно правильный "
          "ответ. Хотя кого я обманываю? Я просто говно-кодер, который не смог реализовать эту возможность.")
    print("\nОстальное ты знаешь: 4 варианта ответа, верен только один. Один неверный ответ — вылет.")
    ...
    game_won = False
    satisfactory_answer_list_1 = ["А", "Б", "В", "Г", "50 X 50", "50X50", "50Х50", "50 Х 50", "Право на ошибку", "ПНО"]
    ...
    if answer_1 == "ПНО" or answer_1 == "Право на ошибку":
        if extra_chance == 1:
            print("\nВы использовали подсказку \"Право на ошибку\". У вас есть две попытки.\n")
            while attempt_1 != 0:
                print("Кто в Far Cry 4 должен был стать новой Тарун Матарой?")  # Сам вопрос
                print("А: Амита")  # Вариант 1
                print("Б: Бхатра")  # Вариант 2
                ...
                while satisfactory_answer_received_1 is False:
                    ...
                    if answer_1 not in satisfactory_answer_list_1:
                        ...
                        break
                if answer_1 != "Б":
                    print("\nОтвет неверен! У вас осталась одна попытка!\n")
                if answer_1 == "Б":
                    break
                attempt_1 -= 1
            extra_chance -= 1
    ...
    if answer_2 == "ПНО" or answer_2 == "Право на ошибку":
        if extra_chance == 1:
            print("\nВы использовали подсказку \"Право на ошибку\". У вас есть две попытки.\n")
            while attempt_2 != 0:
                print("Как называлась лопата с улыбкой в Far Cry 5?")  # Сам вопрос
    ...
    if answer_3 == "ПНО" or answer_3 == "Право на ошибку":
        if extra_chance == 1:
            print("\nВы использовали подсказку \"Право на ошибку\". У вас есть две попытки.\n")
            while attempt_3 != 0:
                print("Как звали Старую Ветошь в серии Dishonored?")  # Сам вопрос
    ...
    if answer_4 == "ПНО" or answer_4 == "Право на ошибку":
        if extra_chance == 1:
            print("\nВы использовали подсказку \"Право на ошибку\". У вас есть две попытки.\n")
            while attempt_4 != 0:
                print("На каком острове располагается дворец герцога в Dishonored 2?")  # Сам вопрос
    ...
    if answer_5 == "ПНО" or answer_5 == "Право на ошибку":
        if extra_chance == 1:
            print("\nВы использовали подсказку \"Право на ошибку\". У вас есть две попытки.\n")
            while attempt_5 != 0:
                print("Какой уровень в компании Geometry Dash восьмой по счёту (от Stereo Madness)?")  # Сам вопрос
    ...
    if answer_6 == "ПНО" or answer_6 == "Право на ошибку":
        if extra_chance == 1:
            print("\nВы использовали подсказку \"Право на ошибку\". У вас есть две попытки.\n")
            while attempt_6 != 0:
                print("Кем для Аджая Гейла является Пейган Мин?")  # Сам вопрос
    ...
    if answer_7 == "ПНО" or answer_7 == "Право на ошибку":
        if extra_chance == 1:
            print("\nВы использовали подсказку \"Право на ошибку\". У вас есть две попытки.\n")
            while attempt_7 != 0:
                print("Сколько очков навыков стоит навык \"Вуаль\" в Far Cry: New Dawn?")  # Сам вопрос
    ...
    if answer_8 == "ПНО" or answer_8 == "Право на ошибку":
        if extra_chance == 1:
            print("\nВы использовали подсказку \"Право на ошибку\". У вас есть две попытки.\n")
            while attempt_8 != 0:
                print("Какой уровень в Geometry Dash НЕ присутствует в Fire Gauntlet?")  # Сам вопрос
    ...
    if answer_9 == "ПНО" or answer_9 == "Право на ошибку":
        if extra_chance == 1:
            print("\nВы использовали подсказку \"Право на ошибку\". У вас есть две попытки.\n")
            while attempt_9 != 0:
                print("Сколько всего прицелов на автоматическую винтовку существует в Far Cry 5?")  # Сам вопрос
    ...
    if answer_10 == "ПНО" or answer_10 == "Право на ошибку":
        if extra_chance == 1:
            print("\nВы использовали подсказку \"Право на ошибку\". У вас есть две попытки.\n")
            while attempt_10 != 0:
                print("На каком из островов располагается город \"Дануол\" в серии Dishonored?")  # Сам вопрос
...
if game_won is not True:
    ...
    if solid_amount_obtained is True:
        ...
        if int(solid_amount) >= 500 and int(solid_amount) < 5000:
        ...
        elif int(solid_amount) >= 5000 and int(solid_amount) < 25000:
